...
#        model = WhisperModel(modelsize, device="cpu", compute_type="int8") #, download_root="faster-disk-cache-dir/")
    ...
    def transcribe(self, audio, init_prompt=""):
        ...
        # segments, info = self.model.transcribe(audio, language=self.original_language, initial_prompt=init_prompt, beam_size=5, word_timestamps=True, without_timestamps=True, condition_on_previous_text=True, **self.transcribe_kargs)
...
class HFWhisperPipelineASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None, hardware="gpu"):
        ...
        logger.info(f"Using backend: HFWhisperPipelineASR with model {model_size_or_path} on {hardware}")
